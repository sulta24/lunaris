...
export default function AboutPage() {
  const schemaData = {
    ...
    "@type": "Organization",
    name: "Lunaris International",
    url: "https://theLunaris.com",
    logo: "https://theLunaris.com/logo.png",
    description:
      "Lunaris International is a 3D product animation agency serving clients in Miami, Los Angeles, New York, Canada, and the UK.",
    sameAs: [
    ...
    <>
      ...
      <section className="py-20 bg-black text-center text-white px-6">
        ...
        <p className="text-lg opacity-80 mb-8">
          Let Lunaris International bring your products to life.
        </p>
        <a
          href="/contact"
