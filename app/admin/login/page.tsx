...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Default credentials
      if (
        (email === "admin@theLunaris.com" && password === "1234") ||
        (email === "Addy@theLunaris.com" && password === "1234")
      ) {
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-600 to-blue-600 p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-semibold text-white">Lunaris</span>
          </div>
          <h1 className="text-4xl font-bold text-white mt-12">Welcome to Lunaris Admin</h1>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="admin@theLunaris.com"
          ...
          <div className="mt-8 text-center">
            <p className="text-neutral-400 text-sm">
              Need help? Contact{" "}
              <a href="mailto:support@theLunaris.com" className="text-[#C6FF3A] hover:underline">
                support@theLunaris.com
              </a>
            </p>
          </div>
        </div>
